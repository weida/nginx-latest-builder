...
images build nginx on updated Ubuntu 24.04, then copy only nginx, required
shared libraries, CA certificates, and passwd/group data into a scratch runtime.
Package-management and archive utilities are not included.
